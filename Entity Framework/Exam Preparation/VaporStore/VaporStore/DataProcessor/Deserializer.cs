namespace VaporStore.DataProcessor
{
    ...
    public static class Deserializer
	{
		...
		public static string ImportGames(VaporStoreDbContext context, string jsonString)
		{
			...
			var gamesJson = JsonConvert.DeserializeObject<ICollection<GameImportDto>>(jsonString);
			...
			foreach (var game in gamesJson)
			{
				...
				sb.AppendLine(String.Format(SuccessfullyImportedGame, gameDb.Name, game.Genre, gameDb.GameTags.Count));
				games.Add(gameDb);
			}
		...
		public static string ImportUsers(VaporStoreDbContext context, string jsonString)
		{
			...
			var usersJson = JsonConvert.DeserializeObject<ICollection<UserImportDto>>(jsonString);
			...
			foreach (var user in usersJson)
			{
				...
				users.Add(userDb);
				sb.AppendLine(String.Format(SuccessfullyImportedUser, userDb.Username, userDb.Cards.Count()));
			}
		...
		public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
		{
			...
			var serializer = new XmlSerializer(typeof(List<PurchaseImportDto>), xRoot);
			var purchasesDto = (List<PurchaseImportDto>)serializer.Deserialize(new StringReader(xmlString));
