    ...
    public partial class PersonalFinancesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class DOSSIERDataTable : global::System.Data.TypedTableBase<DOSSIERRow> {
            ...
            private void InitClass() {
                ...
                this.columnDOSSIER_STATUS.MaxLength = 10;
            }
        ...
        public partial class DOSSIERRow : global::System.Data.DataRow {
            ...
            public decimal? DOSSIER_MIN_BALANCE
            {
                get
                {
                    try
                    {
                        if (Regex.IsMatch(this[this.tableDOSSIER.DOSSIER_MIN_BALANCEColumn].ToString(), correctMinBallancePattern))
                        {
...
namespace PersonalFinances.Data.PersonalFinancesDataSet1TableAdapters {
...
SELECT EMP_ID, EMP_FULLNAME, EMP_USERNAME, EMP_PASSWORD, EMP_IS_ADMINISTRATOR FROM EMPLOYEE WHERE (EMP_ID = @EMP_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EMP_ID, EMP_FULLNAME, EMP_USERNAME, EMP_PASSWORD, EMP_IS_ADMINISTRATOR FRO" +
                "M EMPLOYEE\r\nWHERE EMP_IS_ADMINISTRATOR = \'F\'";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "DELETE FROM [EMPLOYEE] WHERE [EMP_ID] = @Original_EMP_ID";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_EMP_ID", global::System.Data.SqlDbType.Decimal, 9, global::System.Data.ParameterDirection.Input, 18, 0, "EMP_ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy(PersonalFinancesDataSet1.EMPLOYEEDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual PersonalFinancesDataSet1.EMPLOYEEDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            PersonalFinancesDataSet1.EMPLOYEEDataTable dataTable = new PersonalFinancesDataSet1.EMPLOYEEDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int Fired(decimal Original_EMP_ID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((decimal)(Original_EMP_ID));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
